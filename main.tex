...
&
% c2
\multicolumn{1}{Y|}{\textit{拥抱变革来实现客户价值}} & 
% c3
\multicolumn{1}{Y|}{\textit{经常规划和交付软件}} & 
% c4
\multicolumn{1}{Y|}{\textit{以人为本}} & 
% c5
\multicolumn{1}{Y|}{\textit{技术卓越}} & 
% c6
\multicolumn{1}{Y|}{\textit{客户协作}} \\ \hline
...
敏捷项目评估[20] & 
% c4
\multicolumn{1}{X|}{\uline{理想的敏捷物理设置[33]}} & 
% c5
\multicolumn{1}{X|}{\begin{tabularx}{7em}{@{}X@{}}
\uline{测试驱动的开发[11]} \\ \uline{结对开发[49]} \\ \uline{团队中没有或最少化-1或1b级人员[17, 15]} \\
\end{tabularx}} & 
% c6
\multicolumn{1}{X|}{\uline{开发者与顾客经常面对面的互动（协作）[12]}} \\ \hline
